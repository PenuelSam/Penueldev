...
const Banner = () => {
  return (
    <div className='h-full w-full bg-path md:px-[32px] px-6 md:pt-[5rem] pt-[5rem] md:pb-[15rem] pb-[10rem]' >
      
     <div className=' md:w-[1197px]  md:h-[551px] h-[450px]  flex flex-col justify-between '>
     <h1 className='font-MetroSans font-bold md:text-[148px] text-[60px] md:leading-[120px] leading-[50px] md:tracking-[-0.06em] tracking-[-0.02em]'>Creative <span className='textgradient'>Front-End</span> Software Developer.</h1>
