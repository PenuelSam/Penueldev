...
const About = () => {
  return (
    <div className='w-full h-full md:px-[32px] px-6 flex flex-col items-end py-10 relative gap-[40px]'>
      ...
      <div className='w-full flex md:flex-row flex-col gap-[40px] md:gap-[80px] md:items-end items-center'>
        <div className='md:w-[280px] md:h-[360px] w-full'>
            <Image src={photo} alt='' className='w-full h-full object-cover  rounded-md md:rounded-none' width={280} height={360} quality={100} />
        </div>
